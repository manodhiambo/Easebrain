"""
Django settings for easebrainapp project.
...
SECRET_KEY = 'django-insecure-3h%&ewi+g!ac7b+a9s4^85r#qp&61d@bdhhy0x5#*6rg!!uf5c'
...
WSGI_APPLICATION = 'easebrainapp.wsgi.application'
